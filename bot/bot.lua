...
package.cpath = package.cpath..';.luarocks/lib/lua/5.2/?.so'
    bot_token = "374465004:AAE8r2IPZBPBcXhL4cl9Wsqr40PVHGg07e8" --Put You Token Here
   send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 247134702,341567716,366848429,334984718
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {247134702,341567716,366848429,334984718},--Sudo users
    admins = {},
    disabled_channels = {},
